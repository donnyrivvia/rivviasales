...
const navigation = {
  ...
  pages: [
    ...
    { name: "Golden Door", href: "/golden-door" },
  ],
  external: [
    { name: "KnockVia App", href: "https://apps.apple.com/us/app/knockvia/id6737631914", external: true },
    { name: "Rivvia Store", href: "https://rivvia.shop", external: true },
  ],
  social: [
    {
      name: "Instagram",
